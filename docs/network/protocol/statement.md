...
const statementCameraOwnership = {
  ...
  id:
    "8tWrg6LXdHSDu93FgPRasHDTPGxY54WKq3hBLDd1NQja5zzNzko5cKjtGPPJJLQXN1v7NTdkkfh2w14QSVpuB3Gbz9",
  ...
  data: {
    signatures: {
      holder: {
        ...
        // sigHash = CID(sig)
        sigHash:
          "bafk2bzaceah3qsqsaqfkqibi3vkknamxockuff3yfxuyib7mxrpkl4ibryshu",
      },
      issuer: {
        ...
        // sigHash = CID(sig)
        sigHash:
          "bafk2bzaceay6b6tb7ddrl7klvhrsvxl464f5mtcvxnkb2c6bu5urdabiastv6",
      },
    },
    claim: {
      // poe which contains the proof
      poeCid:
        "8tXqFqFA1rBtNEvrEJcgwWETANs4K4NJoCTJv6st4NWDySyigZW8BdBKtQu7qNaBQEqJCM3yKFbjYdvFC2gnKiYKsL",
      ...
      ruleId:
        "8tXqFqFA1rBtNEvrEJcgwWETANs4K4NJoCTJv6st4NWDySyigZW8BdBKtQu7qNaBQEqJCM3yKFbjYdvFC2gsasaKsL",
      ...
      holder:
        "did:substrate:5EJA1oSrTx7xYMBerrUHLNktA3P89YHJBeTrevotTQab6gEY/sensio-network",
      issuer:
        "did:substrate:Hcd78R7frJfUZHsqgpPEBLeiCZxV29uyyyURaPxB71ojNjy/sensio-network",
